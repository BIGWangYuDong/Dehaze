...
parser.add_argument("--inp", default="/home/raid/public/datasets/ntire21/NTIRE2021_Valid_Hazy/",type=str, help="test images path")
...
checkpoint=torch.load(opt.checkpoint)['cleaner']
