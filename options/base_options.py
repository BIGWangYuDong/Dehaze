...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='./DATA/', help='the path of training or testing data')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        parser.add_argument('--name', type=str, default='', help='models are saving here')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--loadfile', type=str, default='New/ZZ/HSV/zz/z4_finetune', help='')
        # model parameters
        ...
        parser.add_argument('--no_dropout', action='store_true', help='no dropout for the generator')
                                         # change store_false when testing
        # dataset parameters
