...
class DehazeNetChangeConcat(BaseNet):
    def __init__(self,
                 backbone,
                 pretrained=None,
                 init_weight_type=None,
                 get_parameter=True,):
        super(DehazeNetChangeConcat, self).__init__(backbone, pretrained, init_weight_type, get_parameter)
    ...
    def _init_layers(self):
        ...
        concat_in1 = 512+512
        concat_in2 = 256+256+512
        concat_in3 = 128+128+256
        concat_in4 = 64+64+128
        concat_in5 = 32+32+64
        ...
        inplanes1 = 1024+concat_out1
        inplanes2 = 512+concat_out2
        inplanes3 = 256+concat_out3
        inplanes4 = 128+concat_out4
        inplanes5 = 64+concat_out5

        self.concat_conv1 = nn.Conv2d(concat_in1, concat_out1, 3, 1, 1)
        self.concat_conv2 = nn.Conv2d(concat_in2, concat_out2, 3, 1, 1)
        self.concat_conv3 = nn.Conv2d(concat_in3, concat_out3, 3, 1, 1)
        self.concat_conv4 = nn.Conv2d(concat_in4, concat_out4, 3, 1, 1)
        self.concat_conv5 = nn.Conv2d(concat_in5, concat_out5, 3, 1, 1)

        self.upblock1 = UpBlock(inplanes1, 512)
        self.upblock2 = UpBlock(inplanes2, 256)
        self.upblock3 = UpBlock(inplanes3, 128)
        self.upblock4 = UpBlock(inplanes4, 64)
        self.upblock5 = UpBlock(inplanes5, 32)
...
class UpBlock(nn.Module):
    def __init__(self, in_fea, out_fea):
        ...
        self.conv1 = nn.Conv2d(in_fea, out_fea, 3, 1, 1)
        self.relu1 = nn.LeakyReLU(0.2, inplace=True)

        self.conv2 = nn.Conv2d(out_fea, out_fea, 3, 1, 1)
        self.relu2 = nn.LeakyReLU(0.2, inplace=True)

        self.conv3 = nn.Conv2d(out_fea, out_fea, 3, 1, 1)
